      ...
      <div className="container mx-auto px-6">
        ...
        {loading ? (
          ...
          <div className="text-center text-slate-500 py-12">
            <p className="text-lg">No certificates available at the moment.</p>
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            ...
            >
              ...
              <div className="w-full md:w-2/5 p-8 md:p-10 flex flex-col bg-white">
                ...
                <div className="space-y-6 flex-1 overflow-y-auto">
                  ...
                  <div className="space-y-4">
                    <DetailRow
                      ...
                      value={selectedCert.certificateNumber || "N/A"}
                      mono
                    />
                    <DetailRow
                      label="Issued Date"
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed py-4 border-t border-slate-100">
                    This document verifies that {selectedCert.issuedBy} has
                ...
                <div className="mt-8 flex gap-3">
                  ...
                  <button
                    onClick={() => window.open(selectedCert.imageUrl, "_blank")}
                    className="flex-1 bg-slate-50 hover:bg-slate-100 text-slate-700 py-3 rounded-xl font-bold text-sm transition-all flex items-center justify-center gap-2 border border-slate-200"
                  >
