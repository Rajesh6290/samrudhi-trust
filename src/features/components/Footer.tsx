    ...
    return (
      <footer className="bg-linear-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12 animate-pulse">
            <div className="space-y-4">
              <div className="h-20 w-32 bg-gray-700 rounded" />
          ...
          <div>
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="text-2xl uppercase font-black tracking-tighter text-white">
                {settings.organizationName.split(" ")[0]} <br />
                <span className="text-orange-500 font-black">
                  {settings.organizationName.split(" ").slice(1).join(" ")}
                </span>
              </span>
            </div>
            <p className="text-gray-400 leading-relaxed mb-4">
              {settings.tagline ||
                "Serving humanity beyond boundaries since 2022. Committed to eliminating hunger and providing emergency support to those in need."}
            </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              ...
              <p className="text-gray-500 text-sm">
                © 2022 - {new Date().getFullYear()} {settings.organizationName}.
                All Rights Reserved.
              </p>
            </div>
