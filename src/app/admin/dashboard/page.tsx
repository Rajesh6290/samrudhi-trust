    ...
    const fetchStats = async () => {
      try {
        ...
        const newStats = {
          ...
          totalFeedback: feedbackData.feedbacks?.lenght || 0,
      ...
      <div className="w-full ">
            ...
            : statCards.map((card, index) => (
                ...
                >
                  <div className="relative bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 p-6 border border-slate-200 hover:border-slate-300 overflow-hidden">
                    ...
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${card.gradientFrom} ${card.gradientTo} opacity-0 group-hover:opacity-5 transition-opacity duration-300`}
                    />
                    ...
                    <div className="relative">
                      ...
                      {/* Hover indicator */}
                      <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-slate-300 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                    </div>
                  </div>
                </motion.a>
              ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-green-600 font-semibold flex items-center gap-1">
                  ...
                  {stats.totalMembers > 0
                    ? (
                        (stats.recentMembers / stats.totalMembers) *
                        100
                      ).toFixed(1)
                    : 0}
                  %
          ...
          >
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-3">
                <div className="bg-gradient-to-br from-purple-500 to-purple-600 p-2.5 rounded-xl shadow-sm">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-green-600 font-semibold flex items-center gap-1">
                  ...
                  {stats.totalGallery > 0
                    ? (
                        (stats.recentGallery / stats.totalGallery) *
                        100
                      ).toFixed(1)
                    : 0}
                  %
